...
class QianwenModel(OpenAICompatibleModel):
    """Compatibility wrapper for the Qianwen OpenAI-compatible endpoint."""
    ...
    def __init__(
        ...
        *,
        ...
        conf = provider_conf or configured_builtin_provider_conf("qianwen")
